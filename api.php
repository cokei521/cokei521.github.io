...
$dockerServices = [
    ...
    ['name' => 'cokei521专用镜像', 'url' => 'https://docker.cokei521.top', 'provider' => 'cokei521专用镜像'],
     ['name' => 'cokei521香港镜像', 'url' => 'https://docker.081011.xyz', 'provider' => 'cokei521香港镜像'],
    ...
    ['name' => 'ghcr加速', 'url' => 'https://ghcr.aeko.cn', 'provider' => 'ghcr加速'],
    ['name' => 'aeko.cn主线', 'url' => 'https://docker.aeko.cn', 'provider' => 'aeko.cn主线'],
    ['name' => 'aeko.cn主线1', 'url' => 'https://dockertest.aeko.cn', 'provider' => 'aeko.cn主线1'],
    ['name' => 'aeko.cn主线2', 'url' => 'https://dockercf.aeko.cn', 'provider' => 'aeko.cn主线2'],
    ['name' => '镜像搜索', 'url' => 'https://docker.xpg666.xyz', 'provider' => '镜像搜索'],
    ['name' => 'Search', 'url' => 'https://dytt.online', 'provider' => 'Search'],
    ['name' => 'Docker镜像搜索', 'url' => 'https://docker.xpg666.xyz', 'provider' => 'Docker镜像搜索'],
    ['name' => 'Docker镜像加速服务', 'url' => 'https://docker-0.unsee.tech', 'provider' => 'Docker镜像加速服务'],
    ['name' => 'Proxy镜像加速', 'url' => 'https://dockerproxy.net', 'provider' => 'Proxy镜像加速'],
    ['name' => '容器镜像管理中心', 'url' => 'https://registry.cyou', 'provider' => '容器镜像管理中心']
];
